<template>
    <FormVeeValidate @submit="submitComment" class="border-info form card-custom">
        <div class="row mb-3 d-flex align-items-start justify-content-center">
            <div class="col-8">
                <Field name="Comentário" rules="required" class="form-control rounded-3" id="floatingTextAreaComment">
                    <template #default="{ field, errors }">
                        <label for="property-description" class="form-label fw-medium">Faça um Comentário:</label>
            ...
            <div class="col-4">
                <Field name="Nota" rules="required" class="form-control rounded-3" id="floatingSelectRatingComment">
                    <template #default="{ field, errors }">
                        <label for="property-description" class="form-label fw-medium">Escolha uma nota de 1 a
                            5.</label>
        ...
        <div class="d-flex align-items-center justify-content-end my-2">
            <button type="submit" class="transition-3d-hover btn btn-primary">
    ...
    methods: {
        ...
        submitComment(values) {
            try {
                ...
                this.addPropertyComment({ comment: payload, propertyId: this.propertyIdByRouteParams })
